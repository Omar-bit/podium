...
const Home = () => {
  ...
  useEffect(() => {
    const loadTeams = async () => {
      try {
        ...
        setError(
          'Impossible de charger les équipes. Veuillez réessayer plus tard.'
        );
  ...
  return (
    <div className='min-h-screen bg-gradient-hero'>
        ...
        <div className='relative container mx-auto px-4 py-16 md:py-24'>
          <div className='flex flex-col items-center text-center space-y-6 animate-fade-in'>
            ...
            <p className='max-w-2xl text-muted-foreground text-lg md:text-xl leading-relaxed'>
              ...
              participantes, explorez leurs soumissions et soyez témoin de
              l'avenir de l'innovation technologique.
            </p>
      ...
      <RealTimeProgress existingteams={teams} />
